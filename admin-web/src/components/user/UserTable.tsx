        ...
        {isLoading ? (
          ...
          users.map((user) => (
            <tr key={user.userId} className="hover:bg-[#f2f3f8]">
              ...
              <td className="p-[1rem] font-semibold">{user.role?.roleName}</td>
              ...
              <td className="p-[1rem]">
                {user?.lastLoginDate &&
                  parseSafeDate(user?.lastLoginDate)?.toLocaleString("vi-VN")}
              </td>

              <td className="p-[1rem]">
                {user?.lockoutEndTime &&
                  parseSafeDate(user?.lockoutEndTime)?.toLocaleString("vi-VN")}
              </td>
